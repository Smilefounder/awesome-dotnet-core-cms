...
* [Halcyon Core CMS](https://github.com/Halcyon-Core/Halcyon-Core) - Open source ASP.NET Core 2.x CMS. It currently supports MS SQL and planned to implement MySQL, SQLite in the near future. It has many built-in features out of the box like multilanguage support, theme, template...
